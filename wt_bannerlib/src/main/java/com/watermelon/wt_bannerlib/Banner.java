...
import com.watermelon.wt_bannerlib.listener.OnBannerClickListener;
import com.watermelon.wt_bannerlib.listener.OnBannerListener;
import com.watermelon.wt_bannerlib.loader.ImageLoaderInterface;
import com.watermelon.wt_bannerlib.view.BannerViewPager;
    ...
    private void setImageList(List<?> imagesUrl) {
        ...
        for (int i = 0; i <= count + 1; i++) {
            ...
            if (imageLoader != null)
                ...
                Log.e(tag, "Please set images com.lilei.banner.loader.");
        }
    }
